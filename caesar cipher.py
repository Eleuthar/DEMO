...
# if the encrypted letter's ASCII code is bigger than "z", reduce the offset value until "z" and use the remainder as offset at the start of the alphabet, otherwise add the offset to the character code
...
# if the derypted letter's ASCII code is lower than "a", reduce the offset value until "a" and use the remainder as offset from the end of the alphabet towards the start, otherwise decrease the offset of the encrypted character code
